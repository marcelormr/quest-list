...
public class QuestList : MonoBehaviour
{
    ...
    static Quest theVaultOfShadows = new Quest(
        ...
        otherRequirements: new OtherRequirements(
            ...
            divinationLevel: 60
            //Time Served Mystery
            //All shadow anchors powered or pylon active
            ),
        isMiniquest: true
        );
    static Quest foreshadowing = new Quest(
        name: "Foreshadowing",
        difficulty: "Novice",
        isMiniquest: true
        );
    ...
    static Quest heartstealer = new Quest(
        name: "Heartstealer",
        difficulty: "Novice",
        questPointsReward: 1
        );
